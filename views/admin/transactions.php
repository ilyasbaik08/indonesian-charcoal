...
<head>
    ...
    <title>Transactions - Indonesian Charcoal</title>
    <style>
        body {
...
<body class="bg-gray-100">
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white py-4 px-6 flex justify-between items-center shadow-md">
        <a href="../../controllers/LogoutController.php" class="text-2xl font-bold italic text-black">
            Indonesian<span class="text-cyan-500"> Charcoal</span>
        </a>
        <div class="flex space-x-4 items-center text-white">
            <span class="text-black hidden md:block font-medium"><?= htmlspecialchars($user['name']); ?></span>
    ...
    <div class="container mx-auto mt-32 px-4 md:ml-72">
        <h1 class="text-3xl font-bold text-cyan-400 mb-6">Daftar Pesanan</h1>
        <div class="overflow-x-auto bg-white border rounded-lg shadow-md">
            <table class="min-w-full">
                <thead>
                    <tr class="bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-left">
